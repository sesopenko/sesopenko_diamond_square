defmodule Sesopenko.DiamondSquare.LowLevelTest do
  ...
  describe "gen_diamond_points" do
    ...
    for scenario <- scenarios do
      ...
      @tag expected_result: scenario[:expected_result]
      test scenario[:label], context do
        result = LowLevel.gen_diamond_points(context[:n], context[:i])
  ...
  describe "gen_square_points" do
    ...
    for scenario <- scenarios do
      ...
      @tag expected: scenario[:expected]
      test scenario[:label], context do
        result = LowLevel.gen_square_points(context[:n], context[:i])
  ...
  describe "gen_diamond_span_list" do
    ...
    for scenario <- scenarios do
      ...
      test scenario[:label], context do
        ...
        result = LowLevel.gen_diamond_span_list(n, iteration)
  ...
  describe "get_feeding_points_for_square" do
    ...
    for scenario <- scenarios do
      ...
      test scenario[:label], context do
        result =
          LowLevel.get_feeding_points_for_square(
            context[:n],
            context[:iteration],
            context[:mid_point]
          )
